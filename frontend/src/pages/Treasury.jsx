...
import { ReceiptsTab } from '../components/treasury/ReceiptsTab';
...
export default function Treasury() {
  ...
  return (
    <div>
      ...
      {activeTab === 'receipts' && (
        <ReceiptsTab
          filterBar={<FilterBar showGateway />}
      ...
      {activeTab === 'btcpay' && (
        <BtcPayTab
          filterBar={<FilterBar />}
          receipts={btcpayReceipts}
          readyReceipts={btcpayReadyReceipts}
          selectedIds={selectedIds}
          toggleReceipt={toggleReceipt}
          openBatch={openBtcpayBatch}
          verifyReceipt={verifyBtcpay}
          verifyingId={verifyingId}
          walletBalance={walletBalanceFor('BTCPAY', 'BTC')}
        />
      )}
      ...
      {activeTab === 'oxapay' && (
        <OxaPayTab
          filterBar={<FilterBar />}
          receipts={oxapayReceipts}
          readyReceipts={oxapayReceipts.filter(isReadyReceipt)}
          selectedIds={selectedIds}
          toggleReceipt={toggleReceipt}
          openBatch={openOxaPayBatch}
          walletBalance={walletBalanceFor('OXAPAY', 'USDT')}
          expenseOutflows={walletExpenseOutflows('OxaPay')}
        />
      )}
